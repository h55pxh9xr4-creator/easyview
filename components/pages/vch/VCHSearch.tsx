            ...
            <table>
              ...
              <tbody>
                {searchResult.items.map((r, i) => {
                  ...
                  return (
                    <tr key={i} onClick={() => handleRowClick(r.voucher_no)}
                      ...
                      <td style={{ color: isSelected ? ORANGE : "#888", fontSize: 11, whiteSpace: "nowrap", fontWeight: isSelected ? 700 : undefined }}>{r.voucher_no}</td>
