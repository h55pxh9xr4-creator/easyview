                ...
                <table style={{ tableLayout: "fixed", width: "100%" }}>
                  ...
                  <tbody>
                    {extract.map((r, i) => {
                      ...
                      return (
                        <tr key={i} onClick={(e) => { if (isSel) { const rect = e.currentTarget.getBoundingClientRect(); triggerComment({ page: PAGE, label: r.voucher_no, value: `${fmtN(r.cash_amount)}원` }, { top: rect.top, right: rect.right }); } else { handleSelectVch(r.voucher_no); } }}
